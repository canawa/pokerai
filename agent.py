...
if __name__ == "__main__":
    ...
    if commands == 'download':
        ...
        state_dict = torch.load('models/model.pt', map_location=device) # сам процесс подгрузки с указанием устройства
    ...
    if commands == 'train':
        ...
        for _ in tqdm(range(1000000)):
            ...
            if _ % 10000 == 0 and _ != 0:
                torch.save(model.state_dict(), 'models/model.pt') # сохраняем веса каждые 10000 шагов
                print('model saved')
        print('training done')
